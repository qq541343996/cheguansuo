...
P = _ReactWX2.default.toClass(P, _ReactWX2.default.Component, {
    ...
    render: function () {
        ...
        return h('view', { 'class': 'page' }, h('image', { mode: 'aspectFit', 'class': 'top-image', src: 'https://s.qunarzz.com/wechatapp/home/banner0510-002.png' }), h('view', { 'class': 'nav-wrapper' }, this.state.indexPageIcons.map(function (item, index) {
            return h('view', { 'class': 'item-wrapper ' + item.class, key: index, onTap: this.gotoSome.bind(this, item.url), 'data-tap-uid': 'e12530', 'data-class-uid': 'c9905', 'data-instance-uid': this.props.instanceUid, 'data-key': index }, h('image', { src: item.logoSrc, 'class': 'itemBgc' }), h('text', { 'class': 'title' }, item.bizTitle), item.showSpecialLogo && item.specialText.length ? h('view', { 'class': 'special-text' }, item.specialText) : '');
        }, this)), h('view', { 'class': 'tool-wrapper' }, this.state.toolData.map(function (item, index) {
            return h('view', { onTap: this.fun_tip, 'class': 'tool-item', key: index, 'data-tap-uid': 'e14036', 'data-class-uid': 'c9905', 'data-instance-uid': this.props.instanceUid, 'data-key': index }, h('image', { src: item.url }), h('text', null, item.title));
            ...
            return h('block', { key: index }, h('swiper-item', { onTap: this.fun_tip, 'class': 'special-offer-item', 'data-tap-uid': 'e15612', 'data-class-uid': 'c9905', 'data-instance-uid': this.props.instanceUid, 'data-key': index }, h('image', { src: item.url }), h('text', null, item.title)));
        }, this))), h('view', { 'class': 'activity' }, h('view', { 'class': 'title' }, '\u6D3B\u52A8\u4E13\u533A'), h('view', { 'class': 'activity-wrapper' }, h('view', { onTap: this.fun_tip, 'class': 'left-content', 'data-tap-uid': 'e16672', 'data-class-uid': 'c9905', 'data-instance-uid': this.props.instanceUid }, h('image', { src: 'https://img1.qunarzz.com/order/comp/1808/c3/dda9c77c3b1d8802.png' }), h('view', { 'class': 'content' }, h('text', { 'class': 'title' }, '\u4F55\u65F6\u98DE'), h('text', { 'class': 'desc' }, '\u673A\u7968\u8D8B\u52BF\u65E9\u77E5\u9053'))), h('view', { 'class': 'right-content' }, h('view', { onTap: this.fun_tip, 'class': 'right-content-wrapper', 'data-tap-uid': 'e17604', 'data-class-uid': 'c9905', 'data-instance-uid': this.props.instanceUid }, h('image', { src: 'https://img1.qunarzz.com/order/comp/1808/3b/fd717d94ed8b6102.jpg\\n' }), h('view', { 'class': 'content' }, h('text', { 'class': 'title' }, '\u4EBA\u683C\u6D4B\u8BD5'), h('text', { 'class': 'desc' }, '\u7B80\u76F4\u60CA\u609A'))), h('view', { onTap: this.fun_tip, 'class': 'right-content-wrapper', 'data-tap-uid': 'e18628', 'data-class-uid': 'c9905', 'data-instance-uid': this.props.instanceUid }, h('image', { src: 'https://img1.qunarzz.com/order/comp/1806/1c/61cd118da20ec702.jpg' }), h('view', { 'class': 'content' }, h('text', { 'class': 'title' }, '\u98DE\u884C\u5B9D\u8D1D'), h('text', { 'class': 'desc' }, '\u699C\u5355\u6709\u793C')))))));;
    },
    classUid: 'c9905'
}, {});
Page(_ReactWX2.default.toPage(P, 'pages/index/index'));
