...
P = _ReactWX2.default.toClass(P, _ReactWX2.default.Component, {
    ...
    render: function () {
        ...
        return h('view', { 'class': 'calendar-containar' }, h(_ReactWX2.default.toComponent, { handleTransmitDate: this.handleShowDate.bind(this),
            $$loop: 'data1462', is: _index2.default }));;
    },
    classUid: 'c888'
}, {});
Page(_ReactWX2.default.toPage(P, 'pages/demo/calendar/index'));
