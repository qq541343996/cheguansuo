    ...
    render: function () {
        ...
        return h('view', { 'class': 'container' }, this.a, h('view', { 'class': 'section section_gap' }, h('view', { 'class': 'section__title' }, '\u8868\u5355\u7EC4\u4EF6\u5728label\u5185'), h('checkbox-group', { 'class': 'group',
            ...
            return h('view', { 'class': 'label-1' }, h('label', null, h('checkbox', { hidden: true, value: item.name, checked: item.checked }), h('view', {
                'class': 'label-1__icon' }, h('view', { 'class': 'label-1__icon-checked', style: _ReactWX2.default.toStyle({ opacity: item.checked ? 1 : 0 }, this.props, 'style6223' + i2285) })), h('text', { 'class': 'label-1__text' }, '                                            ', item.value, '                                        ')));
            ...
            return h('view', { 'class': 'label-2' }, h('radio', { id: item.name, hidden: true, value: item.name, checked: item.checked }), h('view', { 'class': 'label-2__icon' }, h('view', { 'class': 'label-2__icon-checked', style: _ReactWX2.default.toStyle({ opacity: item.checked ? 1 : 0 }, this.props, 'style9349' + i3939) })), h('label', { 'class': 'label-2__text', 'for': item.name }, h('text', null, item.name)));
        }, this))));;
    },
    classUid: 'c5384'
}, {});
Page(_ReactWX2.default.toPage(P, 'pages/demo/native/label/index'));
