...
P = _ReactWX2.default.toClass(P, _ReactWX2.default.Component, {
    ...
    render: function () {
        ...
        return h('view', { 'class': 'container' }, h('radio-group', { 'class': 'radio-group', onChange: this.radioChange, 'data-change-uid': 'e1443', 'data-class-uid': 'c1295', 'data-instance-uid': this.props.instanceUid }, this.state.items.map(function (item, i758) {
            return h('label', { 'class': 'radio' }, h('radio', { value: item.name, checked: item.checked }), item.value);
        }, this)));;
    },
    classUid: 'c1295'
}, {});
Page(_ReactWX2.default.toPage(P, 'pages/demo/native/radio/index'));
