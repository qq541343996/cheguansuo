...
Express = _ReactWX2.default.toClass(Express, _ReactWX2.default.Component, {
    ...
    render: function () {
        ...
        return h('view', { 'class': 'container' }, h('view', { 'class': 'page_hd' }, this.state.title), h('view', { 'class': 'page_bd' }, h('view', { 'class': 'navigation' }, this.state.pages.map(function (page, i2946) {
