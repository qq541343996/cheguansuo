...
P = _ReactWX2.default.toClass(P, _ReactWX2.default.Component, {
    ...
    render: function () {
        ...
        return h('view', { 'class': 'page' }, h('view', null, '\u5FAA\u73AF\u91CC\u9762\u4EA4\u66FF\u4F7F\u7528\u4E24\u5229\u4E0D\u540C\u7684\u7EC4\u4EF6'), h('view', null, this.state.msgList.map(function (msg, i1657) {
            return h('view', { className: 'msg-container clearfix', key: msg.id }, msg.type === 'Cat' && h(_ReactWX2.default.toComponent, { id: msg.id, content: msg.content, $$loop: 'data3849', is: _index2.default, $$index: i1657 }), msg.type === 'Fish' && h(_ReactWX2.default.toComponent, { id: msg.id, content: msg.content, $$loop: 'data4192', is: _index4.default, $$index: i1657 }));
        }, this)), h('radio-group', { 'class': 'radio-group', onChange: this.onSelect.bind(this), 'data-change-uid': 'e4653', 'data-class-uid': 'c2885',
            'data-instance-uid': this.props.instanceUid }, h('radio', { value: 'Cat' }), 'Cat', h('radio', { value: 'Fish' }), 'Fish'), h('textarea', { value: this.state.value, 'auto-height': true, onInput: this.onInput.bind(this), style: 'border:1px solid grey;', 'data-input-uid': 'e5113', 'data-class-uid': 'c2885', 'data-instance-uid': this.props.instanceUid }), h('button', { type: 'button', onTap: this.sendMsg.bind(this), 'data-tap-uid': 'e5323', 'data-class-uid': 'c2885', 'data-instance-uid': this.props.instanceUid }, '\u6DFB\u52A0'));;
    },
    classUid: 'c2885'
}, {});
Page(_ReactWX2.default.toPage(P, 'pages/demo/syntax/loop4/index'));
