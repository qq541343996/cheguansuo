...
var devtools = createCommonjsModule(function (module, exports) {
    ...
    exports.composeEnhancers = function (devtoolOptions) {
        ...
        return (typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__(devtoolOptions) : redux_1.compose;
    };
});
...
var reducers = createCommonjsModule(function (module, exports) {
    ...
    exports.initReducers = function (models, redux) {
        ...
        exports.mergeReducers(models.reduce(function (reducers, model) {
            return __assign({}, exports.createModelReducer(model), reducers);
        }, redux.reducers));
    };
...
var model = createCommonjsModule(function (module, exports) {
    ...
    var addModel = function addModel(model) {
        validate_1.default([[!model, 'model config is required'], [!model.name || typeof model.name !== 'string', 'model "name" [string] is required'], [model.state === undefined, 'model "state" is required']]);
        // run plugin model subscriptions
        core.modelHooks.forEach(function (modelHook) {
            return modelHook(model);
        });
    };
    ...
    var dispatchPlugin = {
        ...
        init: function init(_a) {
            var dispatch = _a.dispatch,
                createDispatcher = _a.createDispatcher,
            ...
            return {
                ...
                onModel: function onModel(model) {
                    ...
                    Object.keys(model.reducers || {}).forEach(function (reducerName) {
                        validate([[!!reducerName.match(/\/.+\//), "Invalid reducer name (" + model.name + "/" + reducerName + ")"], [typeof model.reducers[reducerName] !== 'function', "Invalid reducer (" + model.name + "/" + reducerName + "). Must be a function"]]);
            ...
            return {
                onModel: function onModel(model) {
                    Object.keys(model.effects || {}).forEach(function (effectName) {
                        validate([[!!effectName.match(/\//), "Invalid effect name (" + model.name + "/" + effectName + ")"], [typeof model.effects[effectName] !== 'function', "Invalid effect (" + model.name + "/" + effectName + "). Must be a function"]]);
...
var buildPlugins = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = function (plugins, exposed) {
        return plugins.reduce(function (all, _a) {
            var init = _a.init;
            if (init) {
                var plugin = init(exposed);
                exposed.validate([[plugin.onStoreCreated && typeof plugin.onStoreCreated !== 'function', 'Plugin onStoreCreated must be a function'], [plugin.onModel && typeof plugin.onModel !== 'function', 'Plugin onModel must be a function'], [plugin.middleware && typeof plugin.middleware !== 'function', 'Plugin middleware must be a function']]);
                all.push(plugin);
            }
            return all;
        }, []);
...
var getActionCreators = createCommonjsModule(function (module, exports) {
    ...
    exports.default = function (models) {
        return Object.keys(models).reduce(function (actionCreators, modelName) {
            var _a = models[modelName].reducers,
                reducers = _a === void 0 ? {} : _a;
            Object.keys(reducers).filter(function (reducerName) {
                return !isListener.default(reducerName);
            }).forEach(function (reducerName) {
                var type = modelName + "/" + reducerName;
                actionCreators[type] = function (payload, meta) {
                    return {
...
var getExposed = createCommonjsModule(function (module, exports) {
    ...
    exports.default = function (plugins) {
        return plugins.reduce(function (exposed, plugin) {
            return __assign({}, exposed, plugin.expose || {});
        }, {
...
var getModels = createCommonjsModule(function (module, exports) {
    ...
    exports.default = function (models) {
        return Object.keys(models).map(function (name) {
            return __assign({ name: name }, models[name]);
        });
    };
});
...
var mergeConfig = createCommonjsModule(function (module, exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var merge = function merge(original, next) {
...
var init_1 = createCommonjsModule(function (module, exports) {
    ...
    var init = function init(config) {
        ...
        validate_1.default([[config.plugins && !Array.isArray(config.plugins), 'init config.plugins must be an array'], [config.models && isObject.default(config.models), 'init config.models must be an object'], [config.redux.reducers && isObject.default(config.redux.reducers), 'init config.redux.reducers must be an object'], [config.redux.middlewares && !Array.isArray(config.redux.middlewares), 'init config.redux.middlewares must be an array'], [config.redux.enhancers && !Array.isArray(config.redux.enhancers), 'init config.redux.enhancers must be an array of functions'], [config.redux.combineReducers && typeof config.redux.combineReducers !== 'function', 'init config.redux.combineReducers must be a function'], [config.redux.createStore && typeof config.redux.createStore !== 'function', 'init config.redux.createStore must be a function']]);
